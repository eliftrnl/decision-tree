...
/// </summary>
/// Frontend ile Backend arasında veri alışverişinde format standardization sağlar. Hangi veriler gelebilir, hangi veriler döner bunu belirtir.
...
/// <summary>
/// Request for converting JSON string to Excel
/// </summary>
public record JsonConvertRequest(
    string JsonData
);
